...
@interface CTokenAccess_t : NSObject <TBase, NSCoding> {
...
@interface CTokenAccessResponse_t : NSObject <TBase, NSCoding> {
...
@interface DealOfferGeoSummariesResponse_t : NSObject <TBase, NSCoding> {
...
@interface MerchantsResponse_t : NSObject <TBase, NSCoding> {
...
@interface ValidateCodeResponse_t : NSObject <TBase, NSCoding> {
  BOOL __valid;
  NSString * __codeType;
...
@interface EmailMessageResponse_t : NSObject <TBase, NSCoding> {
  NSString * __subject;
  NSString * __body;
