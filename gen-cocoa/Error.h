...
@interface TServiceException_t : NSException <TBase, NSCoding> {
  int32_t __errorCode;
  NSString * __message;
...
@interface TUserException_t : NSException <TBase, NSCoding> {
  int32_t __errorCode;
  NSString * __param;
...
@interface TNotFoundException_t : NSException <TBase, NSCoding> {
