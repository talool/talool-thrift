...
@interface ServiceException_t : NSException <TBase, NSCoding> {
  int32_t __errorCode;
...
@interface Category_t : NSObject <TBase, NSCoding> {
...
@interface Location_t : NSObject <TBase, NSCoding> {
  double __longitude;
  double __latitude;
...
@interface SocialNetworkDetail_t : NSObject <TBase, NSCoding> {
  int __socalNetwork;
  NSString * __name;
  NSString * __website;
  NSString * __apiUrl;
...
@interface SocialAccount_t : NSObject <TBase, NSCoding> {
  int __socialNetwork;
  NSString * __loginId;
  Timestamp __created;
...
@interface Address_t : NSObject <TBase, NSCoding> {
  NSString * __address1;
  NSString * __address2;
  NSString * __city;
...
@interface MerchantLocation_t : NSObject <TBase, NSCoding> {
...
@interface Customer_t : NSObject <TBase, NSCoding> {
...
@interface Token_t : NSObject <TBase, NSCoding> {
...
@interface Merchant_t : NSObject <TBase, NSCoding> {
...
@interface Deal_t : NSObject <TBase, NSCoding> {
  NSString * __dealId;
...
@interface DealOffer_t : NSObject <TBase, NSCoding> {
  NSString * __dealOfferId;
  Merchant_t * __merchant;
  int __dealType;
  NSString * __title;
...
@interface SearchOptions_t : NSObject <TBase, NSCoding> {
  BOOL __ascending;
...
@interface GiftDetail_t : NSObject <TBase, NSCoding> {
  NSString * __giftId;
...
@interface DealAcquire_t : NSObject <TBase, NSCoding> {
...
@interface Gift_t : NSObject <TBase, NSCoding> {
  NSString * __giftId;
  Deal_t * __deal;
...
@interface DealOfferGeoSummary_t : NSObject <TBase, NSCoding> {
