...
public class Address_t implements org.apache.thrift.TBase<Address_t, Address_t._Fields>, java.io.Serializable, Cloneable, Comparable<Address_t> {
  ...
  public int compareTo(Address_t other) {
    ...
    lastComparison = Boolean.valueOf(isSetAddress1()).compareTo(other.isSetAddress1());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAddress1()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.address1, other.address1);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetAddress2()).compareTo(other.isSetAddress2());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAddress2()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.address2, other.address2);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetStateProvinceCounty()).compareTo(other.isSetStateProvinceCounty());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStateProvinceCounty()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.stateProvinceCounty, other.stateProvinceCounty);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
