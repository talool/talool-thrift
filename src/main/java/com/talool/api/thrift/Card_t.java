...
public class Card_t implements org.apache.thrift.TBase<Card_t, Card_t._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(Card_t other) {
    ...
    Card_t typedOther = (Card_t)other;
    ...
    lastComparison = Boolean.valueOf(isSetExpirationMonth()).compareTo(typedOther.isSetExpirationMonth());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetExpirationMonth()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.expirationMonth, typedOther.expirationMonth);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetExpirationYear()).compareTo(typedOther.isSetExpirationYear());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetExpirationYear()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.expirationYear, typedOther.expirationYear);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetSecurityCode()).compareTo(typedOther.isSetSecurityCode());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSecurityCode()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.securityCode, typedOther.securityCode);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetZipCode()).compareTo(typedOther.isSetZipCode());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetZipCode()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.zipCode, typedOther.zipCode);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
