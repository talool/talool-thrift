...
public class DealOffer_t implements org.apache.thrift.TBase<DealOffer_t, DealOffer_t._Fields>, java.io.Serializable, Cloneable, Comparable<DealOffer_t> {
  ...
  public int compareTo(DealOffer_t other) {
    ...
    lastComparison = Boolean.valueOf(isSetDealOfferId()).compareTo(other.isSetDealOfferId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDealOfferId()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dealOfferId, other.dealOfferId);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetMerchant()).compareTo(other.isSetMerchant());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMerchant()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.merchant, other.merchant);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetDealType()).compareTo(other.isSetDealType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDealType()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dealType, other.dealType);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetDealOfferMerchantLogo()).compareTo(other.isSetDealOfferMerchantLogo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDealOfferMerchantLogo()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dealOfferMerchantLogo, other.dealOfferMerchantLogo);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetDealOfferBackgroundImage()).compareTo(other.isSetDealOfferBackgroundImage());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDealOfferBackgroundImage()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dealOfferBackgroundImage, other.dealOfferBackgroundImage);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
