...
public class SearchOptions_t implements org.apache.thrift.TBase<SearchOptions_t, SearchOptions_t._Fields>, java.io.Serializable, Cloneable, Comparable<SearchOptions_t> {
  ...
  public int compareTo(SearchOptions_t other) {
    ...
    lastComparison = Boolean.valueOf(isSetSortProperty()).compareTo(other.isSetSortProperty());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSortProperty()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.sortProperty, other.sortProperty);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
