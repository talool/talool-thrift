...
public class SocialNetworkDetail_t implements org.apache.thrift.TBase<SocialNetworkDetail_t, SocialNetworkDetail_t._Fields>, java.io.Serializable, Cloneable, Comparable<SocialNetworkDetail_t> {
  ...
  public int compareTo(SocialNetworkDetail_t other) {
    ...
    lastComparison = Boolean.valueOf(isSetSocalNetwork()).compareTo(other.isSetSocalNetwork());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSocalNetwork()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.socalNetwork, other.socalNetwork);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetApiUrl()).compareTo(other.isSetApiUrl());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetApiUrl()) {
