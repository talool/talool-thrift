...
public class MerchantLocation_t implements org.apache.thrift.TBase<MerchantLocation_t, MerchantLocation_t._Fields>, java.io.Serializable, Cloneable, Comparable<MerchantLocation_t> {
  ...
  public int compareTo(MerchantLocation_t other) {
    ...
    lastComparison = Boolean.valueOf(isSetWebsiteUrl()).compareTo(other.isSetWebsiteUrl());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWebsiteUrl()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.websiteUrl, other.websiteUrl);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetMerchantImageUrl()).compareTo(other.isSetMerchantImageUrl());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMerchantImageUrl()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.merchantImageUrl, other.merchantImageUrl);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
