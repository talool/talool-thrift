...
public class ActivityLink_t implements org.apache.thrift.TBase<ActivityLink_t, ActivityLink_t._Fields>, java.io.Serializable, Cloneable, Comparable<ActivityLink_t> {
  ...
  public int compareTo(ActivityLink_t other) {
    ...
    lastComparison = Boolean.valueOf(isSetLinkElement()).compareTo(other.isSetLinkElement());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLinkElement()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.linkElement, other.linkElement);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
