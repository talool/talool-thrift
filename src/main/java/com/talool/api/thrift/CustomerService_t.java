    ...
    private static class getActivities_resultStandardScheme extends StandardScheme<getActivities_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<com.talool.api.thrift.Activity_t>(_list64.size);
                  for (int _i65 = 0; _i65 < _list64.size; ++_i65)
                  {
                    com.talool.api.thrift.Activity_t _elem66; // required
                    _elem66 = new com.talool.api.thrift.Activity_t();
                    _elem66.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getActivities_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (com.talool.api.thrift.Activity_t _iter67 : struct.success)
            {
              _iter67.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class getActivities_resultTupleScheme extends TupleScheme<getActivities_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getActivities_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (com.talool.api.thrift.Activity_t _iter68 : struct.success)
            {
              _iter68.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<com.talool.api.thrift.Activity_t>(_list69.size);
            for (int _i70 = 0; _i70 < _list69.size; ++_i70)
            {
              com.talool.api.thrift.Activity_t _elem71; // required
              _elem71 = new com.talool.api.thrift.Activity_t();
              _elem71.read(iprot);
