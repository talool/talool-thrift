...
public class Customer_t implements org.apache.thrift.TBase<Customer_t, Customer_t._Fields>, java.io.Serializable, Cloneable, Comparable<Customer_t> {
  ...
  public Customer_t(Customer_t other) {
    ...
    if (other.isSetSocialAccounts()) {
      Map<SocialNetwork_t,SocialAccount_t> __this__socialAccounts = new HashMap<SocialNetwork_t,SocialAccount_t>(other.socialAccounts.size());
  ...
  public int compareTo(Customer_t other) {
    ...
    lastComparison = Boolean.valueOf(isSetSocialAccounts()).compareTo(other.isSetSocialAccounts());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSocialAccounts()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.socialAccounts, other.socialAccounts);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                {
                  SocialNetwork_t _key2;
                  SocialAccount_t _val3;
      ...
      if (incoming.get(3)) {
        {
          ...
          {
            SocialNetwork_t _key8;
            SocialAccount_t _val9;
