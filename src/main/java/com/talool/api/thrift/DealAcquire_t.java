...
public class DealAcquire_t implements org.apache.thrift.TBase<DealAcquire_t, DealAcquire_t._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(DealAcquire_t other) {
    ...
    lastComparison = Boolean.valueOf(isSetGiftDetail()).compareTo(typedOther.isSetGiftDetail());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetGiftDetail()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.giftDetail, typedOther.giftDetail);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
